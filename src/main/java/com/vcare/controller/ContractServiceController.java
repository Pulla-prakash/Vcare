...
public class ContractServiceController {
	...
	public String saveContractServices(Model model, @ModelAttribute(value = "serviceObj") ContractService contractServices) {
	  ...
	  @GetMapping("/contractservice/{pularofferId}")
	  public String serviceById(Model model,@PathVariable("pularofferId") int pularofferId, ContractService  contractServices) {
		List<ContractService> conServices=contractServiceRepository.contractServList(pularofferId);
		 popularOffers popularOffers = popularOfferService.getoOfferById(pularofferId);
	  ...
	  @GetMapping("/slotsServices/{pularofferId}/{contractserviceId}")
	  public String slotsByServices(Model model,@PathVariable("pularofferId")int pularofferId,@PathVariable("contractserviceId") int contractserviceId) {
			Patients patient = patientsService.getPatientById(pularofferId);
	 ...
	 @GetMapping("/editofferservice/{offserviceId}") public String getById(Model model, @PathVariable("offserviceId") int offserviceId) {
	      ContractService  objservice = contractServicesService.getByConServiceId(offserviceId);
	      ...
	      model.addAttribute("serviceObj", objservice);
	       ...
	       public String deleteService(Model model, @PathVariable("offserviceId") int offserviceId) {
	           ContractService objservice = contractServicesService.getByConServiceId(offserviceId);
