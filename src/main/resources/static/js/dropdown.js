...
function selectedDate(date){
	...
	document.getElementById('doc').action=appname+"/doctor/Viewdoctors?getQryDate=selectDate&Date="+date;
...
function selectedSlots(date){
	...
	var pid=document.getElementById('patientId').value;
	document.getElementById('contract').action=appname+"/contractService/ViewSlots?getQryDate=selectDate&Date="+date;
